sap.ui.core.mvc.Controller.extend("MIGOTest.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "MIGOTest.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	selectFirstItem : function() {
		...
		if (aItems.length) {
    		...
    		this.getRouter().myNavToWithoutHash({ 
    			currentView : this.getView(),
    			targetViewName : "MIGOTest.view.NotFound",
    			targetViewType : "XML"
        	});
		}
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("Addnr", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
